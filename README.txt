...
comarg.py - A simple support library for dealing with sys.argv in a more user-friendly way. It's even multiplatform... probably... if I did the Windows bit right...